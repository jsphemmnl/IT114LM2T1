...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="rfv" ErrorMessage="Enter your Full Name." ControlToValidate="fullName" runat="server" />
        ...
        <asp:RangeValidator ID="rv" ErrorMessage="Enter a Valid Class." ControlToValidate="age" runat="server" MaximumValue="100" MinimumValue="0" Type="Integer" />
        ...
        <asp:RegularExpressionValidator ID="regex" ErrorMessage="Enter a Valid Email Address." ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" ControlToValidate="email" runat="server" Display="Dynamic"/>
        ...
        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" onclick="click"/>
